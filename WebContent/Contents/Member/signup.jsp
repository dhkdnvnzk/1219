        ...
        <div id="tab2" class="tab_content">
          ...
          <div class="box">
                  ...
                  <form name="business" method="post" action="BusinessServlet?command=business_write_pro">
                    ...
                    <div class="inputBox">
                      <input type="text" name="b_number" style="width:180px;" required onkeyup="this.setAttribute('value', this.value);"  value="">
                  ...
                  <div class="inputBox" >
                    ...
                    <a href="javascript:send2()"><input type="button" value="등록완료."  style="WIDTH: 95pt; HEIGHT: 30pt; font-size : 16px" ></a>
                    <a href="javascript:cansel()"><input type="button" value="취소하기." style="WIDTH: 95pt; HEIGHT: 30pt; font-size : 16px" ></a>
